...
class ProductTag(models.Model):
    ...
    expiry_date = models.DateTimeField(null=True, blank=True, help_text="Залиште пустим для тегу 'new' (авто-14 днів)")
...
class ProductImage(models.Model):
    ...
    variant = models.ForeignKey(ProductVariant, on_delete=models.SET_NULL, null=True, blank=True, related_name='images', help_text="Виберіть варіант, якщо це фото конкретного кольору")
